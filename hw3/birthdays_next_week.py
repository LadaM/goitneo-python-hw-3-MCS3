...
if __name__ == "__main__":
    ...
    users = [
        {"name": "John Doe", "birthday": current_date + timedelta(days=3)},  # Birthday 3 days from today
        {"name": "Alice Smith", "birthday": current_date + timedelta(days=5)},  # Birthday 5 days from today
        {"name": "Bob Johnson", "birthday": current_date + timedelta(days=7)},  # Birthday 7 days from today
        {"name": "Emma Williams", "birthday": current_date + timedelta(days=15)},  # Birthday 15 days from today
        {"name": "Sarah Brown", "birthday": current_date + timedelta(days=20)},  # Birthday 20 days from today
    ]
